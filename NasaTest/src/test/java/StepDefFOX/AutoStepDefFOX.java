...
public class AutoStepDefFOX {
	...
	public void user_is_on_log_on_home_page() throws Throwable {
		driver = BrowserFactory.startBrowser("FIREFOX", "http://automationpractice.com/index.php");
	...
	public void user_enter_userid_and_passwod() throws Throwable {
		...
		System.out.println("Driver Instance for login page is :" + driver);
